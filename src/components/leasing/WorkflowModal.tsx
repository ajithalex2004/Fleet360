    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="w-full max-w-7xl max-h-[94vh] flex flex-col bg-slate-800/95 border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {loading ? (
            <div className="flex items-center justify-center py-16 text-slate-400">Loading workflow...</div>
          ) : (
            <>
              {/* Workflow Pipeline */}
              ...
              <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                <h3 className="text-xl font-bold text-white mb-6">Variance Alerts</h3>
