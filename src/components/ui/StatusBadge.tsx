...
const statusStyles: Record<MaintenanceStatus, string> = {
    ...
    [MaintenanceStatus.JOB_COMPLETED]: 'bg-amber-50 text-amber-700 border-amber-200',
    ...
    [MaintenanceStatus.READY_FOR_OPERATION]: 'bg-green-50 text-green-700 border-green-200',
