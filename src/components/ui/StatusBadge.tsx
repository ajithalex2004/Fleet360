...
const statusStyles: Record<MaintenanceStatus, string> = {
    ...
    [MaintenanceStatus.SUBMITTED]: 'bg-slate-50 text-slate-700 border-slate-200',
    ...
    [MaintenanceStatus.PENDING_OPERATIONS_ACK]: 'bg-yellow-50 text-yellow-700 border-yellow-200',
    [MaintenanceStatus.PENDING_MAINTENANCE_APPROVAL]: 'bg-amber-50 text-amber-700 border-amber-200',
