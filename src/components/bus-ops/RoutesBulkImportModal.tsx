 ...
 *
 * Flow:
 *   1. User drops or picks a file (.csv or .xlsx). We parse client-side with
 *      SheetJS (`xlsx`) — same lib handles both formats — normalise header
 *      names to the canonical set, coerce Excel time cells to HH:MM 24h.
 *   2. Preview panel shows count summary + per-row errors. User can iterate on
 *      the source file and re-drop; nothing hits the DB yet (dryRun POST).
