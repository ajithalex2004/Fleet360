'use client';
/**
 * /bus-ops/headway — Headway management.
 *
 * The page shows every route and lets the user:
...
import { Clock, Plus, Save, Trash2, X, Eye, Calendar } from 'lucide-react';
...
export default function HeadwayPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Headway Management"
        subtitle="Frequency-based scheduling: define time windows and headway intervals. Replaces the per-trip schedule for high-frequency corridors."
        icon={Clock}
        accent="amber"
        actions={
          <button onClick={preview} disabled={!selectedRouteId}
            className="inline-flex items-center gap-1.5 rounded-xl bg-amber-600 hover:bg-amber-500 px-5 py-2.5 text-sm font-semibold text-white disabled:opacity-50">
