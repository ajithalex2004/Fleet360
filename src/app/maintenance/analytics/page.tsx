        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="text-3xl font-bold text-slate-900">{fleetStats.totalVehicles}</p>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="text-3xl font-bold text-slate-900">AED {(fleetStats.totalMaintenanceCost / 1000).toFixed(0)}K</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Cost Trends */}
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    <h3 className="text-lg font-bold text-slate-900 mb-4">Cost Trends (Last 6 Months)</h3>
                    <div className="space-y-3">
                        {costTrends.map(trend => (
                            <div key={trend.month} className="flex items-center gap-3">
                                <span className="text-sm font-medium text-slate-700 w-12">{trend.month}</span>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    <h3 className="text-lg font-bold text-slate-900 mb-4">Maintenance Type Distribution</h3>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                        <div className="text-center">
                            <div className="flex items-center justify-center gap-2">
                                ...
                                <span className="text-sm text-slate-700">Preventive</span>
                            </div>
                            <p className="text-lg font-bold text-slate-900 mt-1">{fleetStats.preventiveVsCorrective.preventive}%</p>
                        </div>
                        <div className="text-center">
                            <div className="flex items-center justify-center gap-2">
                                <div className="w-3 h-3 rounded-full bg-slate-300" />
                                <span className="text-sm text-slate-700">Corrective</span>
                            </div>
                            <p className="text-lg font-bold text-slate-900 mt-1">{fleetStats.preventiveVsCorrective.corrective}%</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-2">
                    <h3 className="text-lg font-bold text-slate-900 mb-4">Top Maintenance Issues</h3>
                        ...
                        <table className="min-w-full divide-y divide-slate-200">
                            ...
                            <tbody className="divide-y divide-slate-200 bg-white">
                                {topIssues.map((issue, idx) => (
                                    <tr key={idx}>
                                        <td className="px-6 py-4 text-sm font-medium text-slate-900">{issue.issue}</td>
                                        <td className="px-6 py-4 text-sm text-slate-700">{issue.occurrences}</td>
                                        <td className="px-6 py-4 text-sm text-slate-700">AED {issue.avgCost}</td>
