          ...
          {(['ALL', 'CRITICAL', 'WARNING', 'NOTICE'] as SeverityFilter[]).map((f) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                sevFilter === f
                  ? 'bg-violet-600 text-[var(--text-main)] shadow'
          ...
          {TYPE_FILTER_OPTIONS.map(({ value, label }) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                typeFilter === value
                  ? 'bg-violet-600/80 text-[var(--text-main)]'
                  : 'text-[var(--text-muted)] hover:text-[var(--text-main)]'
              }`}
            >
              {label}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--border-subtle)]">
                  ...
                  <th className="text-left text-xs font-semibold text-[var(--text-faint)] uppercase tracking-wider px-4 py-3">Lessee / Asset</th>
