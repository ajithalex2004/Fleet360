...
export async function GET(req: NextRequest) {
  ...
  return withTenantRls(prisma, tenantId, async (tx) => {
      ...
      const fleetRows = await tx.$queryRawUnsafe<VehicleRow[]>(
        `SELECT
      ...
      const fuelRows = await tx.$queryRawUnsafe<FuelRow[]>(
        `SELECT
      ...
      // Lease fuel logs
      const leaseFuelRows = await tx.$queryRawUnsafe<FuelRow[]>(
        `SELECT
           COALESCE(UPPER(v.fuel_type), 'DIESEL') AS fuel_type,
      ...
      const tripRow = await tx.$queryRawUnsafe<TripRow[]>(
        `SELECT
      ...
      const racRows = await tx.$queryRawUnsafe<RacRow[]>(
        `SELECT
      ...
      const leaseKmRows = await tx.$queryRawUnsafe<LeaseKmRow[]>(
        `SELECT
           COALESCE(UPPER(v.fuel_type), 'DIESEL') AS fuel_type,
      ...
      const [dpRow] = await tx.$queryRawUnsafe<DpRow[]>(
      ...
      const [evKmRow] = await tx.$queryRawUnsafe<EvKmRow[]>(
      ...
      const [paperlessRow] = await tx.$queryRawUnsafe<PaperlessRow[]>(
        `SELECT
      ...
      const [invRow] = await tx.$queryRawUnsafe<InvRow[]>(
        `SELECT
      ...
      const monthlyRows = await tx.$queryRawUnsafe<MonthRow[]>(
        `SELECT
