  ...
  return withTenantRls(prisma, tenantId, async (tx) => {
    const sp   = req.nextUrl.searchParams;
      ...
      if (type === 'trial_balance') {
        ...
        const rows = await (tx.$queryRawUnsafe as (...a: unknown[]) => Promise<GlRow[]>)(
          `SELECT
      ...
      if (type === 'account_statement') {
        ...
        const [obRow] = await (tx.$queryRawUnsafe as (...a: unknown[]) => Promise<{debit: string; credit: string}[]>)(
        ...
        const [accInfo] = await (tx.$queryRawUnsafe as (...a: unknown[]) => Promise<{account_name: string; account_type: string; normal_balance: string}[]>)(
        ...
        const lines = await (tx.$queryRawUnsafe as (...a: unknown[]) => Promise<GlRow[]>)(
      ...
      const balances = await (tx.$queryRawUnsafe as (...a: unknown[]) => Promise<GlRow[]>)(
        `SELECT
           c.account_code, c.account_name, c.account_type, c.account_subtype,
