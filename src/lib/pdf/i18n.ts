...
export const pdfStrings = {
  ...
  // ── Bus passenger manifest ────────────────────────────────────────────────
  passengerManifest: { en: 'Passenger Manifest', ar: 'قائمة الركاب' },
  manifestNo: { en: 'Manifest No.', ar: 'رقم القائمة' },
  trip: { en: 'Trip', ar: 'الرحلة' },
  tripNumber: { en: 'Trip No.', ar: 'رقم الرحلة' },
  routeName: { en: 'Route', ar: 'المسار' },
  routeOrigin: { en: 'Origin', ar: 'نقطة الانطلاق' },
  routeDestination: { en: 'Destination', ar: 'الوجهة' },
  shift: { en: 'Shift', ar: 'الوردية' },
  driverName: { en: 'Driver', ar: 'السائق' },
  vehicleName: { en: 'Vehicle', ar: 'المركبة' },
  departureAt: { en: 'Departure', ar: 'وقت المغادرة' },
  arrivalAt: { en: 'Arrival', ar: 'وقت الوصول' },
  stop: { en: 'Stop', ar: 'المحطة' },
  paxName: { en: 'Passenger', ar: 'الراكب' },
  paxId: { en: 'Employee ID', ar: 'الرقم الوظيفي' },
  paxDept: { en: 'Department', ar: 'القسم' },
  paxBoard: { en: 'Boarding Stop', ar: 'محطة الصعود' },
  paxAlight: { en: 'Drop Stop', ar: 'محطة النزول' },
  paxStatus: { en: 'Status', ar: 'الحالة' },
  paxBoardedAt: { en: 'Boarded At', ar: 'تم الصعود' },
  s_CONFIRMED: { en: 'Confirmed', ar: 'مؤكد' },
  s_BOARDED: { en: 'Boarded', ar: 'صعد' },
  s_ABSENT: { en: 'Absent', ar: 'غائب' },
  s_NO_SHOW: { en: 'No-Show', ar: 'لم يحضر' },
  emergencyContact: { en: 'Emergency Contact', ar: 'جهة اتصال الطوارئ' },
  manifestFooter: {
    en: 'Carry this manifest in the vehicle for the duration of the trip. Present to law-enforcement / RTA inspectors on request.',
    ar: 'احتفظ بهذه القائمة في المركبة طوال مدة الرحلة. قدمها لمسؤولي إنفاذ القانون / هيئة الطرق والمواصلات عند الطلب.',
  },
  confirmedTotal: { en: 'Confirmed', ar: 'مؤكد' },
  boardedTotal: { en: 'Boarded', ar: 'صعد' },
  absentTotal: { en: 'Absent', ar: 'غائب' },
  noShowTotal: { en: 'No-Show', ar: 'لم يحضر' },
  capacityFigure: { en: 'Capacity', ar: 'السعة' },
  generatedAt: { en: 'Generated', ar: 'تم الإنشاء' },
