...
export const OPS_ASSISTANT_AGENT: AgentDefinition = {
  ...
  description: 'Conversational operations assistant with 16 fleet management, Transport Services domain KPI tiles & BI reporting tools. Powered by TheSys GPT-5 with SSE streaming. Always calls tools to show live data visually.',
  version:     '1.0.0',
