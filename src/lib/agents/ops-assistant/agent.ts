...
export const OPS_ASSISTANT_AGENT: AgentDefinition = {
  ...
  description: 'Conversational operations assistant with 10 fleet management & BI reporting tools. Powered by TheSys GPT-5 with SSE streaming. Always calls tools to show live data visually.',
  version:     '1.0.0',
