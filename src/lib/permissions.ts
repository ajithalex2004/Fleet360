...
export const ALL_PERMISSIONS: { module: Module; action: Action; resource: string; label: string }[] = [
  ...
  { module: 'finance', action: 'view',    resource: 'leasing_billing', label: 'View Leasing Billing in Finance' },
  { module: 'finance', action: 'create',  resource: 'leasing_billing', label: 'Create Leasing Billing Records' },
  { module: 'finance', action: 'edit',    resource: 'leasing_billing', label: 'Edit Leasing Billing Records' },
  { module: 'finance', action: 'approve', resource: 'leasing_billing', label: 'Approve Leasing Billing Actions' },
  { module: 'finance', action: 'export',  resource: 'leasing_billing', label: 'Export Leasing Billing Data' },
